...
create table webdb.humans (id int4 generated by default as identity, birth_date date, city varchar(35), name varchar(30) not null, patronymic varchar(30), surname varchar(30) not null, primary key (id));
...
create table webdb.users (id int4 generated by default as identity, password varchar(100), username varchar(30), primary key (id));
